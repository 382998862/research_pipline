...
jQuery(function () {
    ...
    jQuery(rS + "[data-thumbnail]").append('<div class="arrow-l arrow-l-bottom"></div><div class="arrow-r arrow-r-bottom"></div><div class="mini-images-relative"><ul data-thumbwidth="0" class="mini-images"></ul></div>');
    jQuery(rS + "[data-thumbnail]").each(function () {
        var thumb = jQuery(this).attr("data-thumbnail");
