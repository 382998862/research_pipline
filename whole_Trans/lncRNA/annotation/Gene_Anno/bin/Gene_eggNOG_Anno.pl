...
foreach my $subfile (@subfiles) {
	...
	print OUT "$blastx -task blastx-fast -num_descriptions 100 -num_alignments 100 -evalue $Blast_e -db $eggNOGdb -query $subfile -num_threads 4 -outfmt 5 -out $odir/eggNOG_Dir/$name.eggNOG.blast.xml && \n";
}
close OUT;
