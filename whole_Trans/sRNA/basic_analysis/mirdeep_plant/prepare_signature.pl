...
system("$Bin/convert_bowtie_output.pl $dir/reads_vs_precursors.bwt > $dir/reads_vs_precursors.arf");

system("mkdir $dir/sort_tmp");
...
if($options{a}){
    ...
    system("$Bin/convert_bowtie_output.pl $dir/mature_vs_precursors.bwt > $dir/mature_vs_precursors.arf");
...
#    system("cat $dir/reads_vs_precursors.arf $dir/mature_vs_precursors.arf > $dir/signature_unsorted.arf");
	...
	system("sort -T $dir/sort_tmp -nk1 $dir/signature_unsorted.arf.tmp > $dir/signature_unsorted.arf.tmp2");
...
#	system("sort -V -k6 $dir/signature_unsorted.arf > $outfile");
	...
	system("sort -T $dir/sort_tmp -nk1 $dir/reads_vs_precursors.arf.tmp > $dir/reads_vs_precursors.arf.tmp2");
