...
my $file_fasta=shift or die $usage;		####genome
my $file_arf=shift or die $usage;			###mirdeep_runs/run_*/tmp/Total_reads_collapsed_vs_genome.arf_parsed.arf
my $file_output=shift or die $usage;		###mirdeep_runs/run_*/tmp/precursors.fa
my $coord_file=shift or die $usage;		###mirdeep_runs/run_*/tmp/precursors.coords
my $pres_max=shift;
