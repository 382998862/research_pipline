...
if (-f "$deg/All_DEG_veen.png") {
print DEG <<HTML;
            <div class="block">
                <h3>差异表达基因维恩图</h3>
                <div class="bcon">
                    <p>当比较组合数大于等于2小于等于5时，我们将各组比较得到的差异基因个数进行统计，画成维恩图，以便展现出各个比较组合共有的差异基因数目。</p>
                    <ul>
                        <li>
                            <a target="_blank" href="../DEG_Analysis/All_DEG_veen.png">差异表达基因维恩图；</a>
                            <a target="_blank" href="../DEG_Analysis/All_DEG_veen.genes">差异表达基因列表；</a>
                        </li>
                    </ul>
                </div>
            </div>
...
# ------------------------------------------------------------------
`mv $outdir/deg.html $outdir/deg.html.tmp`;
	...
	print DEG <<HTML;
                    ...
                    <ul>
                        <li>
                            ...
                            <a target="_blank" href="../DEG_Analysis/$ref/$ref.cor.png">表达量散点图；</a>
                            <a target="_blank" href="../DEG_Analysis/$ref/$ref.FC_FDR.png">火山图；</a>
                            <a target="_blank" href="../DEG_Analysis/$ref/$ref.FC_count.png">MA图；</a>
                            <a target="_blank" href="../DEG_Analysis/$ref/DEG_Cluster/hierarchical/$ref.DEG.cluster.png">聚类图；</a>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <a target="_blank" href="../DEG_Analysis/$ref/Graph/$ref.topGO_MF.png">topGO(Molecular Function)；</a>
                            <a target="_blank" href="../DEG_Analysis/$ref/Graph/$ref.topGO_BP.png">topGO(Biological Process)；</a>
                            <a target="_blank" href="../DEG_Analysis/$ref/Graph/$ref.topGO_CC.png">topGO(Cellular Component)；</a>
                        </li>
                        <li>
