...
print OUT "#Gene name\tProtein_name_in_KOG\tE_value\tIdentity\tScore\tOrganism\tKOG_id\tKOG_class_defination\tFunction_code\tFunctional_categories\tFunction_class_defination\n" unless (defined $Nohead);
while (<IN>) {
	my @t = split /\t/;
