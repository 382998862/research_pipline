...
&run_or_die("$Rscript $Bin/pointOrLine.r --infile $od/$Index.insertSize.r.list --outfile $od/$Index.insertSize.png --x.col 1 --y.col 2 --x.lab \"Insert Size (bp)\" --y.lab \"Number of Reads\" --is.line --line.color 1 ");
