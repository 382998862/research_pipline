...
#        my @list1 = ("@A","@B");
#        my @name1 = ("DE_circRNA","DE_Hostgene_circRNA");
	if(scalar(@A)>=2){
...
#       my @list1 = ("@A","@E");
#       my @name1 = ("DE_mRNA","DE_circRNA_Hostgene");
	if(scalar(@list1)>=2){
...
EOF
	...
	print "cd $dir && /share/nas2/genome/biosoft/R/3.1.1/bin/Rscript $name.venn.r\n";
}
