...
print OUT "p <- p + theme( panel.background = element_rect(colour='black', size=1, fill='white'),panel.grid = element_blank())\n";
print OUT 'png(filename="'.$o.'", height = 900, width = 1200, res = 150, units = "px")'."\n";
print OUT "print(p)\n";
print OUT "dev.off()\n";

`/share/nas2/genome/biosoft/R/3.1.1/bin/Rscript All_Type.r`;
`rm All_Type.r`;
