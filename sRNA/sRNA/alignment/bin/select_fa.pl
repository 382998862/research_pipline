...
sub system_Latin{
	...
	if ($system=~m/Chromalveolata/i) {
		...
		$Litan="cre|pta|ppt|smo|ath|bna|bol|bra|cpa|gma|lja|mtr|vun|ghb|ghr|gra|ptc|sly|vvi|osa|sbi|sof|tae|zma|pvu|mdm|bdi|aqc|peu|csi|ccl|crt|ctr|rco|gar|aly|ahy|gso|pab|ttu|ata|hvu|far|bgy|bcy|tcc|rgl|cme|ssp|amg|aau|ssl|stu|pde|atr|pgi|cca|han|har|hci|hex|hpa|hpe|htu|hbr|mes|ama|dpr|lus|ppe|nta|egu";
