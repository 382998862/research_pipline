...
close OUT;
#`/share/nas2/genome/biosoft/R/current/bin/Rscript $Bin/draw_length_distribution.r $od/$prefix.stat  $od/$prefix.length.png`;
runOrDie("$CFG{Rscript} $Bin/draw_length_distribution.r $od/$prefix.stat $od $prefix");
